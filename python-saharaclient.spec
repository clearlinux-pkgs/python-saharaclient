...
Source0  : http://tarballs.openstack.org/python-saharaclient/python-saharaclient-3.1.0.tar.gz
Source1  : http://tarballs.openstack.org/python-saharaclient/python-saharaclient-3.1.0.tar.gz.asc
...
%prep
%setup -q -n python-saharaclient-3.1.0
cd %{_builddir}/python-saharaclient-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586447764
...
cp %{_builddir}/python-saharaclient-3.1.0/LICENSE %{buildroot}/usr/share/package-licenses/python-saharaclient/294b43b2cec9919063be1a3b49e8722648424779
